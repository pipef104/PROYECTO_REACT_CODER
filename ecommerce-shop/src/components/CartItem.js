        ...
        <div className="w-full flex flex-col">
          ...
          <div className=" flex gap-x-2 h-[36px] text-sm">
            ...
            <div className="flex flex-1 max-w-[100px] items-center h-full border text-primary font-medium">
              <div onClick={()=> decreaseAmount(id)} className="flex-1 flex justify-center item-center cursor-pointer ">
                <IoMdRemove />
              </div>
              {/**amount */}
              <div className="">{amount}</div>
              {/**plus icon  */}
              <div onClick={()=> increaseAmount(id)} className="flex-1 flex justify-center item-center cursor-pointer">
                <IoMdAdd />
              </div>
            </div>
            {/**item price */}
